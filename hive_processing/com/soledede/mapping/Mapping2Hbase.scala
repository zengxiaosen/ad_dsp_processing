...
object Mapping2Hbase {
  ...
  case class Params(
                 ...
                 zookeeper_quorum: String ="apark2.soledede.com, spark3.soledede.com, spark1.soledede.com"
                 )
  ...
  def run(params: Params) {
    ...
    var listMp = Source.fromFile(params.input).getLines().foreach{
      line =>
        var fields = line.split(params.file_separator)
